...
import fetchCourses from './utility/fetchCourses';
import {useQuery} from "@tanstack/react-query";
import defaultImage from "../src/public/default.webp";
...
export function CoursesPage({role}:{ role: string | undefined } ) {
                        ...
                        <CardActionArea>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="caption" sx={{ display: 'block', mt: 1 }}>
                                    Start: {data.startDate} | Teacher: {typeof data.teacher === "object" ? data.teacher.name : data.teacher}
                                </Typography>
                            </CardContent>
                        </CardActionArea>
                        <CardActions>
